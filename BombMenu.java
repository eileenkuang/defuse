...
public class BombMenu {
	...
	boolean codeMusic = false;
	boolean giveUpMusic = false;
	boolean defuseMusic = false;
	...
	public GeneralButton defuseCode = new GeneralButton(325, 130, (int) (1024 / 3), (int) (244 / 3),
			defuseCodeUnclicked, defuseCodeClicked);
	...
	public void draw(Graphics g) {
		...
		// if the user presses defuse and the wrong code is entered, the screen turns
		// red
		if (wrongCodeEntered) {
	...
	public void mouseClicked(MouseEvent e) {
		...
		if (crypto.intersects(e.getX(), e.getY(), 1, 1) && !timerBox.intersects(e.getX(), e.getY(), 1, 1)
				&& !defuseCode.intersects(e.getX(), e.getY(), 1, 1)) {
