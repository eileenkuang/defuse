...
public class CryptoMain {
	...
	public CryptoMenus menu = new CryptoMenus();
	...
	public ImageIcon phrase3Icon = new ImageIcon("cryptophrase3.png");
	public Image phrase3 = phrase3Icon.getImage();
	...
	public CryptoKeyboard backspace = new CryptoKeyboard(700, 550, "cryptobackspace.png", "cryptobackspaceclicked.png");
	...
	boolean hintMusic = false;
	boolean quitMusic = false;

	// whether the keys are clicked
	public static boolean[] aClick = new boolean[7];
	public static boolean[] cClick = new boolean[7];
	public static boolean[] dClick = new boolean[7];
	public static boolean[] eClick = new boolean[7];
	public static boolean[] iClick = new boolean[7];
	public static boolean[] kClick = new boolean[7];
	public static boolean[] nClick = new boolean[7];
	public static boolean[] oClick = new boolean[7];
	public static boolean[] pClick = new boolean[7];
	public static boolean[] rClick = new boolean[7];
	public static boolean[] sClick = new boolean[7];
	public static boolean[] uClick = new boolean[7];
	public static boolean[] backspaceClick = new boolean[7];
	...
	public static void reset() {
        ...
        for(int i=1; i<7; i++) {
            backspaceClick[i]=false;
        }

		
		// generate a new phrase from 1 to 3
		phrase = (int) (Math.random() * (3 - 1 + 1)) + 1;
	...
	public void draw(Graphics g) {
		...
		if (phrase == 1) {
			...
			g.drawImage(phrase3, 120, 80, 773, 323, null); // draw phrase
		}

		//draw symbols to their correct locations depending on which key is clicked
		if (aClick[1])
		...
		// draw keys for the user to press
		...
		//draw the hint and quit buttons
	...
	//plays a win sound effect and resets button hovers after the user has won
	public void win() {
	...
	public void mouseClicked(MouseEvent e) {
		...
		if (!BombMenu.solveCrypto) {
			...
			if (hint.intersects(e.getX(), e.getY(), 1, 1)) { //use hint
				showHint = true;
				if(!hintUsed) {
			...
			if (quit.intersects(e.getX(), e.getY(), 1, 1)) { //leave puzzle
		...
		menu.mouseClicked(e); //check if the back button is pressed after the user has won
		...
		if (phrase == 3 && sClick[1] && dClick[2] && kClick[3] && aClick[4] && nClick[5] && dClick[6]) {
			win();
		}
	...
	public void mouseMoved(MouseEvent e) {
		...
		menu.mouseMoved(e); //checks if back button is being hovered over once the user has won

	}

} // end of CryptoMain class
