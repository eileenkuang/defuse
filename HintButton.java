...
public class HintButton extends Rectangle {
	...
	public void draw(Graphics g) {
		if (GamePanel.onlyShowKey) { // if the key puzzle is being played
			if (KeyMain.hintUsed) {// if the hint has been used
				g.drawImage(hintUsedImage, x, y, HINT_WIDTH, HINT_HEIGHT, null);
			} else if (KeyMain.hoverHint) {// if the hint button is being hovered
